...
HD_PWD='c:/users/dev_fw/desktop/cese/vivado/lab2/contador_ip/ip_repo/edit_contador_ip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log contador_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source contador_ip_v1_0.tcl
